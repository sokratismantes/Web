...
-- Χρόνος δημιουργίας: 12 Σεπ 2025 στις 14:32:41
...
(1, 3, 104, 'draft_t3s104_20250902_192419.pdf', '2025-09-02 20:24:19'),
(2, 3, 104, 'draft_t3s104_20250902_192512.pdf', '2025-09-02 20:25:12'),
(3, 3, 104, 'draft_t3s104_20250902_193028.pdf', '2025-09-02 20:30:28'),
...
(200, 'Andreas', 'Komninos', 'Network-centric systems', '2610996915', '6977998877', 'Computer Engineering And Informatics', 'University of Patras', NULL),
(201, 'Vasilis', 'Foukaras', 'Integrated Systems', '2610885511', '6988812345', 'Computer Engineering And Informatics', 'University of Patras', NULL),
(202, 'Basilis', 'Karras', 'Artificial Intelligence', '23', '545', 'Computer Engineering And Informatics', 'University of Patras', NULL),
(203, 'Eleni', 'Voyiatzaki', 'WEB', '34', '245', 'Computer Engineering And Informatics', 'University of Patras', NULL),
(204, 'Andrew', 'Hozier Byrne', 'Artificial Intelligence', '2610170390', '6917031990', 'Computer Engineering And Informatics', 'University of Patras', NULL),
(205, 'Nikos', 'Korobos', 'Data Engineering', '2610324365', '6978530352', 'Electrical Engineering', 'University of Patras', NULL),
(206, 'Kostas', 'Karanikolos', 'informatics', '2610324242', '6934539920', 'Computer Engineering And Informatics', 'University of Patras', NULL),
...
(209, 'Michael', 'Papadreou', 'Renewable Energy Systems', '26104455667', '6974455667', 'Electrical Engineering', 'University of Ioannina', NULL),
(210, 'George', 'Panagiotopoulos', 'Machine Learning', '26104455678', '6974455678', 'Economics', 'University of Patras', NULL),
(211, 'Maria', 'Alexiou', 'Robotics', '2610778899', '6977788899', 'Electrical Engineering', 'University of Patras', NULL),
(212, 'Ioannis', 'Tsoukalas', 'Data Science', '2310334455', '6940334455', 'Economics', 'Aristotle University of Thessaloniki', NULL),
(213, 'Eleni', 'Papadimitriou', 'Environmental Engineering', '2310445566', '6980445566', 'Environmental Science', 'University of Ioannina', NULL),
(214, 'Dimitris', 'Lazaridis', 'Cybersecurity', '2610556677', '6977556677', 'Electrical Engineering', 'University of Patras', NULL),
(215, 'Anna', 'Kollia', 'Cloud Computing', '2101234567', '6981234567', 'Environmental Science', 'National Technical University of Athens', NULL),
(216, 'Christos', 'Papanikolaou', 'Bioinformatics', '2109876543', '6949876543', 'Electrical Engineering', 'University of Crete', NULL),
(217, 'Fotis', 'Markou', 'Blockchain Technology', '2610112233', '6970112233', 'Economics', 'University of Patras', NULL),
(218, 'Stella', 'Karagianni', 'Cultural Economics', '2104567890', '6984567890', 'Economics', 'Athens University of Economics and Business', NULL),
(219, 'Petros', 'Zaharopoulos', 'Renewable Energy Systems', '2610667788', '6976667788', 'Electrical Engineering', 'University of Ioannina', NULL),
(290, 'Andreas', 'Komninos', 'Network-centric systems', '2610996915', '6977998877', 'CEID', 'University of Patras', NULL),
(291, 'Vasilis', 'Foukaras', 'Integrated Systems', '2610885511', '6988812345', 'CEID', 'University of Patras', NULL),
(292, 'Basilis', 'Karras', 'Artificial Intelligence', '23', '545', 'CEID', 'University of Patras', NULL);
...
(4, 108, 11, 200, 'Pending', '2025-08-02 15:14:50', NULL, NULL, NULL),
...
(72, 110, 19, 200, 'Accepted', '2025-08-18 17:44:57', '2025-08-19 18:53:23', NULL, ''),
(73, 110, 19, 204, 'Accepted', '2025-08-18 17:44:57', '2025-08-19 18:48:51', NULL, ''),
...
(78, 110, 19, 203, 'Rejected', '2025-08-18 18:01:59', NULL, NULL, ''),
(79, 110, 19, 212, 'Pending', '2025-08-18 18:01:59', NULL, NULL, ''),
...
(1, 'Ανάπτυξη Εφαρμογής Διαχείρισης Εργασιών με AI', 'Εφαρμογή που χρησιμοποιεί AI για ταξινόμηση και παρακολούθηση καθημερινών εργασιών.', 'Υπό Εξέταση', '2025-10-01', NULL, NULL, NULL, NULL, NULL, NULL, 106, 206, NULL, NULL, NULL, NULL, '2024/001', '[]', NULL),
...
(5, 'Σύστημα Προβλέψεων Καιρού με Χρήση Machine Learning', 'Δημιουργία αλγορίθμου πρόβλεψης καιρού με χρήση ιστορικών δεδομένων.', 'Περατωμένη', '2024-08-01', NULL, NULL, NULL, NULL, '2025-05-15', 9.33, 100, 200, 'https://repository.university.gr/thesis/124', NULL, NULL, NULL, '2023/020', '[]', NULL),
...
(7, 'Εφαρμογή Εντοπισμού Διαρροών σε Δίκτυα Ύδρευσης', 'Ανάλυση δεδομένων από αισθητήρες για εντοπισμό διαρροών σε δίκτυα ύδρευσης.', 'Περατωμένη', '2024-06-15', NULL, NULL, NULL, NULL, '2025-02-28', 8.25, 105, 205, 'https://repository.university.gr/thesis/126', NULL, NULL, NULL, '2023/018', '[\"https:\\/\\/www.upatras.gr\\/education\\/undergraduate-studies\\/school-of-engineering\\/department-of-computer-engineering-and-informatics\\/\"]', NULL),
...
(12, 'Διαχείριση Ενέργειας με Συστήματα IoT', 'Ανάπτυξη συστήματος παρακολούθησης και βελτιστοποίησης κατανάλωσης ενέργειας.', 'Υπό Ανάθεση', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '[]', NULL),
...
(17, 'test', 'test', 'Ενεργή', '2022-08-17', NULL, NULL, NULL, NULL, '2025-08-31', NULL, 117, 200, NULL, '', '', 2025, NULL, '[]', NULL),
(19, 'τεστ2', 'τεστ2', 'Υπό Ανάθεση', '2025-08-31', NULL, NULL, NULL, NULL, '2027-09-28', NULL, 110, 200, NULL, NULL, NULL, NULL, NULL, '[]', NULL),
...
(33, 'τεστ8', 'τεστ8', 'Υπό Ανάθεση', '2025-09-30', NULL, NULL, NULL, NULL, '2025-10-31', NULL, NULL, 200, NULL, NULL, NULL, NULL, NULL, '[]', 'uploads/theses_pdfs/thesis_33.pdf'),
...
(65, 'Ανάπτυξη Εφαρμογής Παρακολούθησης Υγείας', 'Εφαρμογή για παρακολούθηση ζωτικών σημείων.', 'Ενεργή', '2025-10-05', NULL, NULL, NULL, NULL, NULL, NULL, 100, 210, NULL, NULL, NULL, NULL, '2024/021', '[]', NULL),
...
(69, 'Ανάλυση Ήχου για Αναγνώριση Συμβάντων', 'Ανίχνευση συγκεκριμένων ήχων σε ηχογραφήσεις.', 'Ενεργή', '2025-10-09', NULL, NULL, NULL, NULL, NULL, NULL, 104, 214, NULL, NULL, NULL, NULL, '2024/025', '[]', NULL),
...
(72, 'Ανάλυση Κυκλοφορίας Δεδομένων Δικτύου', 'Παρακολούθηση και ανάλυση δικτυακής κυκλοφορίας.', 'Ενεργή', '2025-10-12', NULL, NULL, NULL, NULL, NULL, NULL, 107, 217, NULL, NULL, NULL, NULL, '2024/028', '[]', NULL),
...
(74, 'Ανίχνευση Ανεπιθύμητων Emails', 'Φιλτράρισμα spam με ML αλγόριθμους.', 'Ενεργή', '2025-10-14', NULL, NULL, NULL, NULL, NULL, NULL, 109, 219, NULL, NULL, NULL, NULL, '2024/030', '[]', NULL),
...
(77, 'Αυτόματο Σύστημα Ελέγχου Ποιότητας Εικόνας', 'Ανίχνευση σφαλμάτων σε εικόνες προϊόντων.', 'Ενεργή', '2025-10-17', NULL, NULL, NULL, NULL, NULL, NULL, 112, 212, NULL, NULL, NULL, NULL, '2024/033', '[]', NULL),
...
(80, 'Ανίχνευση Κακοήθων Ενεργειών σε Δίκτυο', 'Συστήματα ασφάλειας δικτύου με ML.', 'Ενεργή', '2025-10-20', NULL, NULL, NULL, NULL, NULL, NULL, 115, 215, NULL, NULL, NULL, NULL, '2024/036', '[]', NULL),
...
(82, 'Ανάλυση Συμπεριφοράς Χρηστών Web', 'Παρακολούθηση και ανάλυση χρηστών ιστοσελίδων.', 'Ενεργή', '2025-10-22', NULL, NULL, NULL, NULL, NULL, NULL, 117, 217, NULL, NULL, NULL, NULL, '2024/038', '[]', NULL);
...
--
ALTER TABLE `theses`
  MODIFY `thesis_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=83;
