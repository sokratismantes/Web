...
$examStmt = $pdo->prepare("
    ...
    WHERE t.student_id = :student_id AND t.status = 'Υπο Εξέταση' AND r.thesis_id IS NULL
    LIMIT 1
");
...
<div class="thesis-grid">
    <?php foreach ($theses as $thesis): ?>
        <div class="thesis-card" onclick="window.location.href='view_student.php?thesis_id=<?php echo $thesis['thesis_id']; ?>';">
           ...
           <?php if ($hasFinalThesis): ?>
    <div class="action-buttons" style="margin-top: 15px;">
        <a href="thesis_exam_report.php?thesis_id=<?= $thesis['thesis_id'] ?>" class="action-button blue">Πρακτικό Εξέτασης</a>
    </div>
<?php else: ?>
    <div class="action-buttons" style="margin-top: 40px;">
        <a href="student_action.php" class="action-button blue">Διαχείριση Διπλωματικής Εργασίας</a>
        <a href="epilogitrimelousepitropis.php" class="action-button blue">Επιλογή Τριμελούς Επιτροπής</a>
    </div>
<?php endif; ?>
