...
// Βρες πληροφορίες καθηγητή από το email
$stmt = $pdo->prepare("
...
<head>
    ...
    <!-- Roboto font (ταιριάζει με το CSS) -->
    ...
    <style>
        ...
        /* === Γενικές μεταβάσεις & βασικό animation === */
        * {
        ...
        /* === Διάταξη πλήρους ύψους & gradient φόντο με overlay === */
        html, body {
            height: 100%;
            margin: 0;
            padding: 0;
        ...
        /* === Header (υφιστάμενη κλάση .header) === */
        .header {
            display: flex;
            align-items: center;
        ...
        /* === Ενότητα “Ανακοινώσεις Μου” (κάρτες) === */
...
/* ——— Διαχωριστική λωρίδα ανάμεσα σε sections ——— */
.section-divider{
  width:min(1100px,92%);
