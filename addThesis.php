...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Χειρισμός PDF
    $uploadedPdfPath = null; // ΤΕΛΙΚΟ σχετικό path 
    $pdfTempRel = null;      // προσωρινό σχετικό path 
...
<head>
    ...
    <style>
        ...
        .btn-silver-blue:hover{ filter:saturate(1.03); }
        .btn-silver-blue:focus-visible{ outline:3px solid rgba(11,75,166,.25); outline-offset:2px; }
        .btn-silver-blue{
...
<div class="container">
    ...
    <form method="POST" action="addThesis.php" enctype="multipart/form-data">
        ...
        <!-- Πρότυπο ονομασίας PDF -->
        <label for="pdf_name_pattern">Όνομα αρχείου PDF (πρότυπο):</label>
        <input type="text" id="pdf_name_pattern" name="pdf_name_pattern" placeholder="...">
        <div class="hint">
            Το <code>default όνομα αρχείου</code> θα αντικατασταθεί αυτόματα από το <strong>πρότυπο</strong> που δημιουργείται.
        </div>

        <button type="submit" class="btn-silver-blue">Προσθήκη Θέματος</button>
    </form>
</div>
