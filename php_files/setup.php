...
try {
   ...
   "); 
    ...
    echo "Ο πίνακας `users` δημιουργήθηκε και τα δεδομένα προστέθηκαν επιτυχώς.<br>";
...
try {
    ...
    echo "Ο πίνακας `students` δημιουργήθηκε και τα δεδομένα προστέθηκαν επιτυχώς.<br>";
} catch (PDOException $e) {
    echo "Σφάλμα: " . $e->getMessage();
}
?>
...
<?php
try {
    // Δημιουργία πίνακα professors
    $pdo->exec("
CREATE TABLE IF NOT EXISTS professors (
    professor_id INT(11) NOT NULL PRIMARY KEY,
    name VARCHAR(50) NOT NULL,
    surname VARCHAR(50) NOT NULL,
    ...
    echo "Ο πίνακας `professors` δημιουργήθηκε και τα δεδομένα προστέθηκαν επιτυχώς.<br>";
} catch (PDOException $e) {
    echo "Σφάλμα: " . $e->getMessage();
}
?>
...
try {
    ...
    echo "Ο πίνακας `grammateia` δημιουργήθηκε και τα δεδομένα προστέθηκαν επιτυχώς.<br>";
} catch (PDOException $e) {
    echo "Σφάλμα: " . $e->getMessage();
}
?>
...
try {
    ...
    // Εισαγωγή δεδομένων
    $pdo->exec("
        INSERT INTO theses (thesis_id, title, description, status, start_date, end_date, final_grade, student_id, supervisor_id) VALUES
    ...
    echo "Ο πίνακας `theses` δημιουργήθηκε και τα δεδομένα προστέθηκαν επιτυχώς.<br>";
} catch (PDOException $e) {
    echo "Σφάλμα: " . $e->getMessage();
}
?>
...
try {
    ...
    // Εισαγωγή δεδομένων
    $pdo->exec("
        INSERT INTO committees (thesis_id, supervisor_id, member1_id, member2_id) VALUES
        (1, 3, 204, 209, 210),
        (2, 5, 200, 211, 212),
        (3, 6, 216, 219, 208),
        (4, 7, 205, 200, 217),
    ...
    echo "Ο πίνακας `committees` δημιουργήθηκε και τα δεδομένα προστέθηκαν επιτυχώς.<br>";
} catch (PDOException $e) {
    echo "Σφάλμα: " . $e->getMessage();
}
?>
...
<?php
try {
    // Δημιουργία πίνακα committeeinvitations
    $pdo->exec("
    ...
    // Εισαγωγή δεδομένων
    $pdo->exec("
        INSERT INTO committeeinvitations (thesis_id, invited_professor_id, status, sent_at, responded_at, comments) VALUES
    ...
    echo "Ο πίνακας `committeeinvitations` δημιουργήθηκε και τα δεδομένα προστέθηκαν επιτυχώς.<br>";
} catch (PDOException $e) {
    echo "Σφάλμα: " . $e->getMessage();
}
?>
...
<?php
try {
    // Δημιουργία πίνακα progressnotes
    $pdo->exec("
    ...
    // Εισαγωγή δεδομένων
    $pdo->exec("
        INSERT INTO progressnotes (thesis_id, content, sender_type) VALUES
        (1, 'Η εργασία προχωρά κανονικά.', 'Teacher'),
        (2, 'Χρειάζεται περαιτέρω καθοδήγηση.', 'Student'),
        (3, 'Η πρώτη φάση ολοκληρώθηκε.', 'Teacher');
    ");

    echo "Ο πίνακας `progressnotes` δημιουργήθηκε και τα δεδομένα προστέθηκαν επιτυχώς.<br>";
} catch (PDOException $e) {
    echo "Σφάλμα: " . $e->getMessage();
}
?>
...
<?php
try {
    // Δημιουργία πίνακα presentations
    $pdo->exec("
    ...
    // Εισαγωγή δεδομένων
    $pdo->exec("
        INSERT INTO presentations (thesis_id, date, time, location) VALUES
        (1, '2025-10-15', '10:00:00', 'Αίθουσα 101'),
        (2, '2025-09-20', '12:00:00', 'Αίθουσα 202'),
        (3, '2025-08-25', '14:00:00', 'Αίθουσα 303');
    ");

    echo "Ο πίνακας `presentations` δημιουργήθηκε και τα δεδομένα προστέθηκαν επιτυχώς.<br>";
} catch (PDOException $e) {
    echo "Σφάλμα: " . $e->getMessage();
}
?>
...
<?php
try {
    // Δημιουργία πίνακα attachments
    $pdo->exec("
        CREATE TABLE IF NOT EXISTS attachments (
            attachment_id INT(11) NOT NULL AUTO_INCREMENT,
            thesis_id INT(11) NOT NULL,
            uploader_type ENUM('Teacher', 'Student') NOT NULL,
    ...
    // Εισαγωγή δεδομένων
    $pdo->exec("
        INSERT INTO attachments (thesis_id, uploader_type, uploader_id, file_name, file_url, file_type) VALUES
        (1, 'Teacher', 200, 'AI_Research.pdf', 'http://example.com/files/AI_Research.pdf', 'PDF'),
        (2, 'Student', 101, 'Social_Data.docx', 'http://example.com/files/Social_Data.docx', 'Word'),
        (3, 'Teacher', 204, 'Blockchain_Report.pdf', 'http://example.com/files/Blockchain_Report.pdf', 'PDF');
    ");

    echo "Ο πίνακας `attachments` δημιουργήθηκε και τα δεδομένα προστέθηκαν επιτυχώς.<br>";
} catch (PDOException $e) {
    echo "Σφάλμα: " . $e->getMessage();
}
?>
...
try {
    ...
    echo "Ο πίνακας `invitations` δημιουργήθηκε επιτυχώς.<br>";
} catch (PDOException $e) {
    echo "Σφάλμα: " . $e->getMessage();
}
?>
<?php
try {
    // Δημιουργία πίνακα professors_notifications
    $pdo->exec("
CREATE TABLE IF NOT EXISTS professors_notifications (
    id INT AUTO_INCREMENT PRIMARY KEY,
    ...
    echo "Ο πίνακας `professors_notifications` δημιουργήθηκε επιτυχώς.<br>";
} catch (PDOException $e) {
    echo "Σφάλμα: " . $e->getMessage();
}
?>